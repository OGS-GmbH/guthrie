import type {DynamicElementProps, DynamicValue} from "../renderer/type.ts";
import {useGuthrieVariables} from "../stores/variables.ts";
import {useEffect, useState} from "react";
import {touchByAccess} from "../renderer/variables.ts";
